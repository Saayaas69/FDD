...
function showSignup() {
    ...
    document.querySelector('.auth-subtitle').textContent = 'Join the Sportify community';
}
...
function goBack() {
    ...
    document.querySelector('.auth-subtitle').textContent = 'Join the sports community';
}
